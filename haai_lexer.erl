...
yystate(18, Ics, Line, Tlen, _, _) ->
    {9,Tlen,Ics,Line,18};
yystate(17, [70|Ics], Line, Tlen, Action, Alen) ->
...
yystate(10, Ics, Line, Tlen, _, _) ->
    {7,Tlen,Ics,Line,10};
yystate(9, [70|Ics], Line, Tlen, Action, Alen) ->
...
yystate(2, [68|Ics], Line, Tlen, Action, Alen) ->
    yystate(13, Ics, Line, Tlen+1, Action, Alen);
yystate(2, Ics, Line, Tlen, Action, Alen) ->
    {Action,Alen,Tlen,Ics,Line,2};
yystate(1, [67|Ics], Line, Tlen, Action, Alen) ->
...
-file("./haai_lexer.xrl", 13).
yyaction_0(TokenChars, TokenLine) ->
     { token, { int, TokenLine, list_to_integer (TokenChars) } } .

-compile({inline,yyaction_1/2}).
-file("./haai_lexer.xrl", 14).
yyaction_1(TokenChars, TokenLine) ->
     { token, { instruction, TokenLine, TokenChars } } .

-compile({inline,yyaction_2/1}).
-file("./haai_lexer.xrl", 15).
yyaction_2(TokenLine) ->
     { token, { rref, TokenLine } } .

-compile({inline,yyaction_3/1}).
-file("./haai_lexer.xrl", 16).
yyaction_3(TokenLine) ->
     { token, { dref, TokenLine } } .

-compile({inline,yyaction_4/1}).
-file("./haai_lexer.xrl", 17).
yyaction_4(TokenLine) ->
     { token, { src, TokenLine } } .

-compile({inline,yyaction_5/1}).
-file("./haai_lexer.xrl", 18).
yyaction_5(TokenLine) ->
     { token, { '(', TokenLine } } .

-compile({inline,yyaction_6/1}).
-file("./haai_lexer.xrl", 19).
yyaction_6(TokenLine) ->
     { token, { ')', TokenLine } } .

-compile({inline,yyaction_7/2}).
-file("./haai_lexer.xrl", 20).
yyaction_7(TokenChars, TokenLine) ->
     { token, { op, TokenLine, TokenChars } } .

-compile({inline,yyaction_8/1}).
-file("./haai_lexer.xrl", 21).
yyaction_8(TokenLine) ->
     { token, { reaktor, TokenLine } } .

-compile({inline,yyaction_9/2}).
-file("./haai_lexer.xrl", 22).
yyaction_9(TokenChars, TokenLine) ->
     { token, { atom, TokenLine, TokenChars } } .

-compile({inline,yyaction_10/0}).
-file("./haai_lexer.xrl", 23).
yyaction_10() ->
     skip_token .
